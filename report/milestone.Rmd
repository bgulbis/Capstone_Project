...
These data sets will be used to build a predictive text model. The two-word pairs and three-word phrases will be utilized to predict the next most-likely word based upon the word currently entered. 

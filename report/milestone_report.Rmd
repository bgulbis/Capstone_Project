...
**NOTE:** The source R code to generate the tables and figures in this report can be found [here](https://github.com/bgulbis/Capstone_Project/report/milestone_report.Rmd).
